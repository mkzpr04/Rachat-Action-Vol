...
def evaluate_single_episode(model, S0, sigma, N, Q,results, batch_size=Batch):
...
results=simulate_episode(model, S0, sigma, days, goal, flag=False, batch_size=Batch)
S_n, A_n, q_n, X_n, v_n, somme_density, bell_n, episode_payoff=results

stats_batch = evaluate_single_episode(model, S0, sigma, days, goal,results, batch_size=Batch)
