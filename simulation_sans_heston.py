# -*- coding: utf-8 -*-
"""
Created on Sat Nov 30 23:01:10 2024
...
if choice == 'c':
    ...
    try:
        ...
        if continue_training == 'o':
            ...
            train_model(model, simulate_episode=simulate_episode, num_episodes=num_episodes, S0=S0, sigma=sigma, days=days, goal=goal,batch_size=Batch)
...
num_episodes = 100
avg_total_spent, avg_total_stocks, avg_A_n, avg_payoff, avg_final_day, avg_actions = evaluate_policy(model, num_episodes, S0, sigma, days, goal, batch_size=Batch)
...
S_n, A_n, q_n, total_spent, actions, log_densities, cloche_n, episode_payoff = simulate_episode(
    model, S0, sigma, days, goal, flag=False, batch_size=Batch
)
